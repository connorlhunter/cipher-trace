...
/** Renders Cipher Trace coverage from JSON without browser automation. */
export async function renderCoveragePdfs(
  ...
  await new Promise<void>((resolve, reject) => {
    const document = new PDFDocument({
      info: { Title: "Cipher Trace Coverage" },
      margin: 48,
      size: "LETTER",
    });
    ...
    document.font("Helvetica-Bold").fontSize(22).fillColor("#17202a").text("Cipher Trace Coverage");
    document
      .moveDown(0.35)
      .font("Helvetica")
      .fontSize(10)
