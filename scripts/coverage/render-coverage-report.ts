...
function indexHtml(updatedAt: string): string {
  return page(
    "Cipher Trace coverage",
    `<header><h1>Cipher Trace coverage</h1><p>Available reports are grouped by code surface. Each requires at least ${minimumCoveragePercent}% line and function coverage.</p></header><div class="table-wrap"><table><thead><tr><th>Page</th><th>Scope</th></tr></thead><tbody><tr><td><a href="typescript/index.html">TypeScript</a></td><td>Trace-event contracts and browser-facing control-plane boundaries</td></tr><tr><td><a href="python/index.html">Python</a></td><td>FastAPI control plane, Lambda adapter, and shared contracts</td></tr></tbody></table></div>`,
    "index.html",
    updatedAt,
    "overview",
  );
