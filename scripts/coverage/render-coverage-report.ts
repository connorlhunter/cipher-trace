...
/** Builds Cipher Trace's single structured coverage artifact. */
...
/** Writes JSON coverage data for the portfolio's native reader. */
...
function setMetric(
  ...
  return {
    ...file,
    [metric]: { ...file[metric], [field]: metricValue },
  };
}
